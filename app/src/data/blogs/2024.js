...
i came home to a new mattress on my bed, and my parents sold the entire guest bed. the new mattress is nice, it's really high. my parents keep changing my furniture without my permission, this time they didn't even ask me. i need to get my own house. i noticed my parents started knocking on the door before they enter my room. even my dad did it when he came in to show me the pictures, my mom must have taught him. `,
  ...
  {
    date: "11/23",
    content: `he can make you feel less lonely but only you can make yourself happy with being alone. you have to be content with yourself, be proud of yourself, look up to yourself, admire yourself, prefer to spend time with yourself, like how you would a significant other but you have to do that for yourself. no one can replace you for yourself. no one can fill a hole that you can't fill for yourself. 
...
time flies, so soon these will be the golden days`,
  },
  {
    ...
    date: "9/21",
    content: `go out without makeup on. wear the same outfit five days in a row. forget to look in the mirror before you leave the house. tell your friends about the minute details of your inner life. never smile when you don't feel genuinely happy. 
...
moment of silence... lowk in grief`,
  },
  {
    ...
    date: "9/4",
    content: `i just realized i should probably be doing a travel blog while i'm here in japan. but i was too busy feeling like a foreigner to think of blogging
...
right when i was getting comfortable my reservation time was over and i had to leave. it's so interesting, that business, at the beginning they give you pigs and then at the end they take them away.`,
  ...
  {
    date: "9/2",
    content: `you know that feeling you get the first night you're at a new place. it always goes away after the first night. but it's like a feeling of alienation, or maybe crippling loneliness or overwhelming nostalgia. like you're completely alone in the world . 
...
but it always goes away after the first night`,
  },
  {
    ...
    date: "9/2",
    content: `guess what i got a job...! kind of. i sent over the information to ‘start the onboarding process' for a position that's been in the works with this person since last year. so... not kms :D i hope this works out :)`,
  },
  {
    title:
      "bruh ihave no pasion and i am NOT eager TT like i wan ta job but it's not like that. im msorry its so corny TT just like something like that but cut the fluff. i feel like i have no concrete experiences ToT",
    date: "8/27",
    content: "",
  },
  {
    title: "kms",
    date: "8/27",
    content: `updating linkedin is so painful `,
  },
  {
    title: "thoughts going into the 2024 school year",
    date: "8/26",
    content: `im afraid of letting people down and im afraid of not being able to handle it and im afraid of losing sleep and not being good enough. 
...
i need to spend more time in the backyard though. i used to see entire worlds in there, and spend entire afternoons just exploring and finding interesting things in the garden. so many creatures have lived and died there; they've been there all this time, even when i stopped noticing. if i'm observant and a bit lucky, once nature takes its pickings, i sometimes get to keep a little piece for myself too`,
  ...
  {
    date: "8/24",
    content: `isn't it crazy how i write multiple blog posts a day. like how do i find the time for this 

(oh right im unemployed Xd)`,
  },
  {
    date: "8/24",
    content: `hiii today was lowkey a peak day it was productive, vibey and chill but also out of the ordinary because i found my lizard and i also prepared for my upcoming college workshop (which i'm leading), packed for japan (!!!) and drew my dog >.< i showed it to my mom and she said it looked really like her and actually the drawings look kind of funky but i honestly think that's just because my dog just looks kind of funky in the first place. so i think they look pretty true to the reference.`,
  },
  {
    date: "8/24",
    content: `omg guys i found another lizard today while i was walking my dog i decided to go a bit further than we usually go and it was in the middle of the sidewalk covered with ants. and i stared at it for a while and i decided i wanted it so i picked it up with a poopy bag and all the ants went crazy and scattered and a few of them stayed on the lizard . 
...
i might end up posting some stuff like this on my blog. i've been really inspired by non-edited youtube videos, where people just post unedited videos of themselves talking or whatever and i'm not brave enough to do that. but maybe i will post unedited writings onto my blog, when i make it, because i kinda hate editing my writing anyways and when i edit i feel that i sometimes over-edit it and write over my own voice. somehow, even though i'm the one editing. this is kind of raw though... although nobody's going to be reading my blog honestly as far as i'm concerned`,
  ...
  },
  {
    ...
    date: "8/22",
    content: `remember when you used to go to the cafeteria and look at the lunch menu options and if they had one of the good ones it would make your day? we used to line up for the bosco sticks, and the chicken tenders, if they were served with tater tots, and in my opinion the pizza was good sometimes too. and there was always the crustables pb&j but sometimes it was served cold. maybe it was the lunch ladies way of taking revenge.`,
  },
  {
    title: "dear diary",
    date: "8/22",
    content: `did you know that i actually journal every day. i have been writing in a journal of some kind every day since i was in probably the 2nd grade. i've skipped some days for sure and even some years. why don't we call it a diary anymore, once we grow up past a certain point? this is my diary.`,
  },
  {
    date: "8/21",
    content: `today i felt quite busy and i even started to feel a bit overwhelmed. progress on my website is slow, and i have some work for my other projects that i have to think about soon. but to be honest i kind of appreciate this feeling of being slightly overwhelmed, it makes me a bit excited, i think i might be a bit masochistic. i've made some progress on my coding, but i still have so much to learn.`,
  },
  {
    title: "hideout",
    date: "8/21",
    content: `when we were small my friend and i used to hide out in a little bathroom cabinet, under the sink. we would crawl in there through the cabinet door, one at a time, and curl in our legs so that we could both fit. it was cramped and stuffy, and when we brought in the bunnies, the four of us could barely fit. sometimes we talked quietly, or napped, or sat and listened to each other's breathing. we would whisper about how if the clowns ever came while we were here, they would never find us. 
...
i used to think my parents didn't know about our secret little hideout under the sink. i would crawl in there by myself sometimes, too... when i wanted somewhere to escape, to feel like it was just me and nothing else. just to get away. `,
  },
  {
    ...
    date: "8/19",
    content: `This summer, I failed to find a job. 
...
`,
  },
  {
    ...
    date: "8/19",
    content: `hello, and welcome to my personal webpage! this site is forever a work in progress, but i hope to use it as an platform to share my thoughts, creations, and inspirations, and also just to do wtv i want
