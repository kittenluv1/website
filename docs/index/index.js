document
  ...
  .addEventListener(
    "dblclick",
    () => (window.location.href = "https://www.bunnyluv1.com/blog/2026/"),
  );
document
...
document
  ...
  .addEventListener("dblclick", () =>
    window.open("https://introspec.itch.io/flappypatchi"),
  );
document
  .getElementById("neocities")
  .addEventListener("dblclick", () =>
    window.open("https://kittenluv1.neocities.org/"),
  );
document
...
document
  ...
  .addEventListener(
    "dblclick",
    () => (window.location.href = "https://www.bunnyluv1.com/gallery/"),
  );
document
  .getElementById("microblog")
  .addEventListener("dblclick", () => (window.location.href = "microblog"));
